...
def main():
    ...
    lost_font = pygame.font.SysFont("cominsans", 100)
    ...
    def redraw_window():
        ...
        if lost:
            ...
            WIN.blit(lost_label,
                     (int((WIDTH - lost_label.get_width()) / 2), int((HEIGHT - lost_label.get_height()) / 2)))
    ...
    while run:
        ...
        if key[pygame.K_s] and player.y + player_vel + player.get_height() + 15 < HEIGHT:
            player.y += player_vel
